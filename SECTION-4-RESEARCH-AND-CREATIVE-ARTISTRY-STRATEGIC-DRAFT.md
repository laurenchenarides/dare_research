...
### Position relative to selected R1 peers

The department's publication and citation record establishes a clear internal baseline, but the central evaluative question is how that record compares with similarly situated R1 departments. Appendix Table B1 is reserved for DARE's Scholarly Research Index (SRI) and rank or percentile relative to selected peers. Appendix Table B2 is reserved for the Academic Analytics Productivity Radar, which considers articles, citations, grants, grant dollars, books, conference proceedings, awards and honors, and cross-institutional collaboration together. Appendix Table D4 will provide the more detailed peer comparison for citation and publication-impact indicators. These comparisons should account for unit size, faculty appointment structure, disciplinary composition, and reporting period. Total output alone will favor larger departments, while per-faculty indicators without aligned faculty definitions may obscure DARE's combined research, teaching, and Extension appointments.

> Add the peer-comparison findings to this paragraph and complete Appendix Tables B1, B2, and D4 using an Academic Analytics export for DARE and an agreed set of R1 agricultural and resource economics comparison units. Report the SRI, total and per-faculty publications, citations, citations per publication, grant activity, books, conference proceedings, honors, and cross-institutional collaboration. Use the same comparison year, faculty definition, disciplinary taxonomy, and metric window for every unit. Interpret where DARE exceeds, approximates, or falls below the peer median and 75th percentile. Obtain the export through CSU's authenticated Academic Analytics access and verify the peer set with department and college leadership.

Because the Academic Analytics results are not yet available, the draft cannot currently state where DARE leads or trails its R1 peers. Once obtained, the comparison should show how DARE performs on both total and per-faculty measures of publications, citations, grants, awards, and collaboration. Reporting both forms will keep differences in department size from determining the interpretation and will identify the specific indicators on which DARE can claim strength or should seek improvement.

The publication totals and Google Scholar citations in Tables 4.1 and 4.2 describe DARE's curated publication portfolio. Academic Analytics citations per publication should be used for the peer comparison because the same database and definitions can then be applied to DARE and every comparison unit. The two sources answer related but different questions and should not be combined into one measure.

## Sponsored research leadership and portfolio development

DARE was the lead unit on 153 proposals submitted during the 2021–2026 reporting window (Table 4.4). Eighty-five proposal records were recorded as funded, representing 55.6 percent of DARE-led proposals and $63.42 million in total award value. The award count and award dollars measure different aspects of performance: the former is the number of funded project records, while the latter is the combined value of those awards. The recorded funded share is not a final proposal success rate because records without a final status include both proposals that were not funded and proposals still in progress. The 2026 results are partial.
...
Award values should not be presented as research expenditures. Awards record sponsored resources committed to projects, often across several years, while expenditures show when and how those resources were used. Comparable expenditure and graduate research assistant data are needed before DARE's use of sponsored resources can be assessed against R1 peers or other CAS departments.

> Add annual sponsored-project expenditures, graduate research assistant appointments and expenditures, requested dollars, resolved proposal outcomes, and award dates. Obtain these measures from the Office of the Vice President for Research, CAS research administration, and university financial and appointment systems. Use them to compare expenditures per active tenure-track faculty member, the share of sponsored resources supporting graduate researchers, final proposal success, and active-project counts with appropriate CAS and R1 benchmarks.
...
> Add Academic Analytics measures of within-department and cross-institutional collaboration, CSU subunit affiliations for publication coauthors, and DARE participation and leadership in USDA Multistate Research Projects. Obtain the collaboration measures through Academic Analytics or faculty verification and the multistate-project records from participating faculty or department records. Use these additions to validate the patterns in Appendix Tables E1 and E3, complete Appendix Table E4, and show which partnerships could support the next generation of interdisciplinary proposals.
...
> Add or update the awards committee's internal working table to identify potential candidates, appropriate university or disciplinary awards and fellowships, eligibility windows, nomination deadlines, and evidence needed for each nomination. Supplement publication and grant indicators with current editorships, editorial-board service, association offices, elected fellow status, major review panels, prior awards, policy contributions, and mentoring records from faculty CVs and a brief faculty verification.

DARE also supports the development and retention of faculty researchers through onboarding, a formal mentor committee for pre-tenure faculty, annual review by the full promotion-and-tenure committee, and at least annual individual meetings with the department head. Associate professors may opt into a new mentor committee with a less formal structure. These mechanisms provide recurring opportunities to set research priorities, assess progress, identify barriers, and connect faculty with collaborators and recognition opportunities. Appendix Table F2 should document the frequency, participants, and intended outcomes of each mentoring mechanism.

> Add the details needed to complete Appendix Table F2 from the department's onboarding document, promotion-and-tenure procedures, mentor-committee guidance, and department-head practices. Confirm how the optional associate-professor committee is initiated and reviewed.
...
> Add undergraduate and graduate research participation, graduate research assistant appointments and trends, student conference presentations, participation in graduate research laboratories, community-engaged research projects, other scholarly products, and resulting placements or awards. Obtain these records from graduate-program files, university appointment data, faculty annual activity reports, graduate-laboratory records, student travel records, and a targeted faculty request. Where possible, describe the competencies students developed and the positions, graduate programs, or professional opportunities that followed.
...
- CSU-authenticated [Academic Analytics](https://shibidp.colostate.edu/idp/profile/SAML2/Redirect/SSO?execution=e1s1) resources for R1 peer comparisons, Scholarly Research Index measures, and collaboration indicators.
...
5. A compact Academic Analytics peer-comparison table after authenticated data are obtained.

Appendices:

1. Department composition and research-area detail.
2. Full Academic Analytics peer tables and citation benchmarks.
3. Sponsored awards by source, sponsor, pass-through institution, CAS department, and collaboration direction; F&A distributions; and, when available, proposal-success and expenditure tables.
...
6. Competitive recognitions, scholarly service, and faculty mentoring supports.
...
| Strong journal placement and 4,649 verified citations | Establish DARE's position relative to comparable R1 units | Secure recurring Academic Analytics access, agree on a peer set, and assign responsibility for annual benchmarking | Support defensible claims about national standing and identify specific areas for improvement |
