...
These areas serve as research clusters within the department. They reflect disciplinary subfields and align faculty research, teaching, and Extension activities with the needs of Colorado and its stakeholders. During some portion of the 2021–2026 review period, the department identifies 19 faculty associated with Agricultural and Food Economics, 10 with ENRE, and three with Agricultural Education. Faculty collaborate across these areas through publications, sponsored projects, and graduate committees.
...
From 2021 through August 2026, DARE faculty produced 344 peer-reviewed faculty-publication credits (Table 4.1). A faculty-publication credit counts one publication for each participating DARE faculty member, so this combined total recognizes each faculty member's contribution to an article, whether solo-authored or co-authored. The 344 credits correspond to 264 unique department publications. Each article is counted only once in the unique department publication total. Fifty-seven publications included two or more DARE faculty authors, demonstrating that the department's research productivity is collaborative.
...
Faculty capacity provides additional context for these totals. Annual active tenure-track headcount ranged from 23 to 26 during the five completed years. Research FTE measures the portion of those faculty appointments formally assigned to research: a faculty member with a 40 percent research appointment contributes 0.40 research FTE. Summing these individual research shares produced 8.06 to 9.56 research FTE across the department. The headcount and FTE figures therefore describe the same faculty from different perspectives rather than indicating a reduction from 23–26 people to 8.06–9.56 people. Unique publications per active tenure-track faculty member ranged from 1.56 to 2.28, while unique publications per tenure-track research FTE ranged from 4.30 to 6.16. Headcount provides the more direct basis for comparison with peer departments; research FTE better reflects DARE's appointment structure, in which faculty combine research with teaching, Extension, and service. The annual publication chart and the comparison of publications with faculty headcount and research FTE are presented in Appendix Figures D1 and D2.
...
DARE's funded portfolio involved 31 originating sponsors. The three largest were the USDA Agricultural Marketing Service, with five awards totaling $50.87 million; the USDA National Institute of Food and Agriculture, with 21 awards totaling $4.20 million; and the USDA Forest Service Rocky Mountain Research Station, with six awards totaling $1.27 million. Together they accounted for 88.8 percent of award dollars. Most of this concentration comes from the $50.0 million Northwest Mountain Food Business Center award, for which Dawn Thilmany served as principal investigator. This award demonstrates DARE's capacity to lead a major regional initiative. At the same time, dependence on USDA funding creates an opportunity to broaden the portfolio while maintaining the department's strong USDA partnerships.

University pass-through arrangements form a distinct part of the portfolio. Across CAS, 66 external higher-education institutions served as pass-through organizations on 259 proposals, including 100 funded awards totaling $17.56 million. DARE worked through 27 of those institutions on 51 DARE-led proposals; 30 funded awards involving 19 pass-through institutions totaled $2.02 million. Federal agencies were the originating source of 79.7 percent of DARE's pass-through award dollars. This share is lower than the 94.9 percent federal share for DARE's full award portfolio, indicating that the pass-through portion was somewhat more diversified by originating source, although it remained predominantly federal. It does not describe the funding portfolios of the partner universities and therefore cannot show whether those institutions are more diversified overall. These relationships extend DARE's network of university partners and provide access to larger externally sponsored initiatives.
...
To evaluate the breadth of collaboration beyond the department, DARE examined the institutional affiliations of publication coauthors using OpenAlex. OpenAlex is an open catalog of scholarly works, authors, institutions, and citation relationships, and provides the structured authorship and affiliation information used for this analysis. These records identify coauthors and collaborating institutions.

OpenAlex identified at least one external institutional affiliation on 192 of the department's 264 peer-reviewed publications. Across these publications, the affiliation data identify 326 external institutions. Of these, 195 were universities or other educational institutions and 37 were government organizations; the remainder included nonprofit organizations, industry, research facilities, and other institution types. The network included 180 U.S. institutions and 141 institutions across 40 other countries; country information was unavailable for five institutions. The University of Wyoming was the most frequent identifiable university partner, appearing on 24 publications. Other recurring partners included the USDA Agricultural Research Service, USDA Economic Research Service, Kansas State University, Texas A&M University, Appalachian State University, Cornell University, and the Rocky Mountain Research Station. This pattern combines strong regional and federal relationships with a broad national and international network. **Appendix Table E3** reports publication relationships separately from funded-project relationships. Because some publications lack affiliation information, the documented network is a conservative estimate.
...
### Table C7. Proposal and award activity across CAS academic departments, 2021–2026

| CAS academic department | Proposals submitted | Funded awards | Recorded funded share | Total award dollars | Average award amount |
|---|---:|---:|---:|---:|---:|
| Soil and Crop Sciences | 401 | 224 | 55.9% | $96,577,947 | $431,152 |
| Agricultural and Resource Economics | 153 | 85 | 55.6% | $63,423,126 | $746,154 |
| Agricultural Biology | 416 | 224 | 53.8% | $36,428,215 | $162,626 |
| Animal Sciences | 281 | 121 | 43.1% | $17,603,737 | $145,485 |
| Horticulture and Landscape Architecture | 241 | 95 | 39.4% | $11,214,958 | $118,052 |

Note: Results are based on proposal-submission cohorts, and 2026 is partial. Full multi-year award amounts are assigned to the submission year and are not annual expenditures.

### Appendix Figure C1. Distribution of F&A rates by direct-sponsor category

![Distribution of F&A rates by direct-sponsor category](output/figures/figure_grant_fa_rate_by_sponsor_type.png)
